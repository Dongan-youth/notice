...
const ModeBtn = () => {
  return (
    <div className='flex justify-center items-center w-[7.25rem] h-[4rem] bg-[#F6F6F9] rounded-[0.625rem] mx-[1.88rem]'>
      <div className='flex justify-center items-center w-[6rem] h-[3rem] bg-[#C6CCD8] rounded-[0.625rem]'>
