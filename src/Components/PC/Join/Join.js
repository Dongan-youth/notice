  ...
  return (
    <div className="flex flex-col justify-center items-center gap-5 w-80">
      ...
      <TextField
        ...
        onChange={(e) => setJoinData({ ...joinData, pwcheck: e.target.value })}
      />
      <TextField
        id="outlined-basic"
        name="phone"
      ...
      >
        <span className="text-[#FFFFFF] text-[1.25rem] font-bold font-[Inter] cursor-default">
          Join
        </span>
      </button>

      <div className="flex flex-row w-[15.1875rem] gap-[0.25rem] mt-3">
